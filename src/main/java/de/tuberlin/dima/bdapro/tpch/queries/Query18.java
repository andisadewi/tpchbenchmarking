...
public class Query18 extends Query {
	...
	public Query18(ExecutionEnvironment env, String sf) {
		super(env, sf);
		// TODO Auto-generated constructor stub
	}
	
	public List<Tuple6<String, Integer, Integer, String, Double, Double>> execute(int testQty) {
		quantity = testQty;
		return execute();
	}
...
//		Filter lineitems for inner query
		private FilterFunction<Tuple2<Integer, Double>> filterLineitemInQ(int qty) {
