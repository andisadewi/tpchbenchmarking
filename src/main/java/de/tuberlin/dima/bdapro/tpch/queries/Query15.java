...
public class Query15 extends Query {
	...
	public Query15(ExecutionEnvironment env, String sf) {
		super(env, sf);
		// TODO Auto-generated constructor stub
	}
	
	public List<Tuple5<Integer, String, String, String, Double>> execute(String testDate) {
	...
	public List<Tuple5<Integer, String, String, String, Double>> execute() {
		...
		try{
			...
			reuslt.map(new MapFunction<Tuple5<Integer, String, String, String, Double>, 
				...
				@Override
                    public Tuple5<Integer, String, String, String, Double> map(Tuple5<Integer, String, String, String, Double> value) throws Exception {
                        return value;
                    }
	...
	//filter lineitmes
		private FilterFunction<Tuple4<Integer, Double, Double, String>> filterLineitems(LocalDate date) {
