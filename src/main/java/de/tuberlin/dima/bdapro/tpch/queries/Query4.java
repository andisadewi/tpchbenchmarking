...
public class Query4 extends Query {
    ...
    public Query4(ExecutionEnvironment env, String sf)
    {
        super(env,sf);
    }
    @Override
    public List<Tuple2<String,Long>> execute() {
        ...
        DataSet<Tuple2<String,Long >> result = orders.join(l_orderkey)
            ...
            @Override
            public Tuple1<String> join(Tuple3<Long, String, String> orders, Tuple1<Long> lineitems) {
    ...
    private FilterFunction<Tuple3<Long, String, String>> filterOrders(LocalDate randomDate) {
        return (FilterFunction<Tuple3<Long, String, String>>) value -> {
    ...
    private class CountItemsInGroup implements GroupReduceFunction<Tuple1<String>, Tuple2<String,Long>> {
        @Override
        public void reduce(Iterable<Tuple1<String>> iterable, Collector<Tuple2<String, Long>> collector) throws Exception {
            Long count = 0L;
            String key = null;
    ...
    private class RetrieveOrderKey implements MapFunction<Tuple3<Long, String, String>, Tuple1<Long>> {
        @Override
        public Tuple1<Long> map(Tuple3<Long, String, String> record) throws Exception {
