...
public class Query16 extends Query {
    ...
    String type = getRandomType2();
    public Query16(ExecutionEnvironment env, String sf) {
        super(env, sf);
    }
    ...
    private FilterFunction<Tuple4<Long, String, String, Integer>> filterPart(String brand, String type) {
    ...
    private class CountItemsInGroup implements GroupReduceFunction<Tuple4<String,String,Integer,Long>, Tuple4<String,String,Integer,Long>> {
        @Override
        public void reduce(Iterable<Tuple4<String, String, Integer, Long>> iterable, Collector<Tuple4<String, String, Integer, Long>> collector) throws Exception {
            Long count = 0L;
